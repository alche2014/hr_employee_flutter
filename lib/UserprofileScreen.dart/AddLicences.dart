...
class AddLicencesInfo extends StatefulWidget {
  final data, editable, uid;
  const AddLicencesInfo({Key? key, this.data, this.editable, this.uid})
      : super(key: key);

  @override
  _AddLicencesInfoState createState() => _AddLicencesInfoState();
}

class _AddLicencesInfoState extends State<AddLicencesInfo> {
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: DropdownButtonFormField<String>(
                            decoration: TextFieldDecoration("Certificate Type"),
                            value: type,
                        ...
                        const SizedBox(height: 15),
                        Text("  Licences Date", style: TextFieldHeadingStyle()),
                        const SizedBox(height: 10),
                        Padding(
