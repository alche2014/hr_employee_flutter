        ...
        body: Stack(children: [
          ...
          NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
              buildMyNewAppBar(context, 'Notifications', true),
            ],
            body: SizedBox(
                                                            ...
                                                            Container(
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          color: snapshot.data!.docs[index]["title"] == "Announcement"
                                                                              ? Colors.blue
                                                                              : snapshot.data!.docs[index]["title"] == "Leave Approved"
                                                                                  ? Colors.green
                                                                        ...
                                                                        child:
                                                                            Icon(
                                                                          snapshot.data!.docs[index]["title"] == "Announcement"
